...
export function RealTimeWidget({ data }: RealTimeWidgetProps) {
    ...
    return (
        <aside className="rounded-lg border border-zinc-200 bg-white p-3">
            ...
            <p className="mt-0.5 text-2xl font-semibold text-blue-600">{ data?.activeVisitors ?? 0 }</p>
            <p className="text-[10px] font-medium uppercase tracking-wide text-zinc-400">currently active</p>
